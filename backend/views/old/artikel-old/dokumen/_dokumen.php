...
<div class="box-header">
    <?= Html::a('<i class="fa fa-plus-circle"></i> Tambah Dokumen Upload', ['tambah-dokumen-terkait','id'=>$id], ['class' => 'btn btn-success btn-flat']) ?>

    <?= Html::a('<i class="fa fa-plus-circle"></i> Tambah Dokumen List', ['tambah-dokumen-terkait-list','id'=>$id], ['class' => 'btn btn-warning btn-flat']) ?>    
    <p></p>
    <?= GridView::widget([
