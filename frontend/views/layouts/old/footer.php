        ...
        <div class="footer-top">
            <div class="container">
                <div class="row">
                    ...
                    <section class="col-lg-4 col-md-43 col-xs-12 col-sm-4 footer-four wow fadeIn">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6 ">
                        <p class="credits">&copy; Copyright 2018 by <a href="#">FIFOLAB</a>. All Rights Reserved. </p>
                    </div>
                    <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6 ">
