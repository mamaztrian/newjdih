<div class="container">
          <div class="tittle wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
              <h2 style="font: 400 24px 'Alegreya',serif;">Sejarah</h2>
          </div>
...
<li>Dalam tahap permulaan ada dua hal yang perlu dilakukan:
<ol type="a">
...
<p class="text_content">Pada tahun 1978 dilaksanakan Lokakarya tentang “Organisasi dan Komunikasi Sistem Jaringan Dokumentasi dan Informasi Hukum” di Jakarta, yang salah satu hasilnya adalah menunjuk BPHN sebagai Pusat Jaringan dan diberi tugas sebagai penyelenggara latihan pembinaan tenaga, tempat konsultasi, penelitian dan pengembangan sistem jaringan, serta koordinator kegiatan unit-unit jaringan dalam rangka pengembangan jaringan.</p>
<p class="text_content">Dalam rangka melaksanakan tugas sebagai Pusat JDIH, pada tahun 1988 BPHN mengeluarkan pedoman pengelolaaan dokumen hukum yang diberi nama ”Manual Unit Jaringan Dokumentasi dan Informasi Hukum” yang terdiri dari V modul yaitu:</p>
<ol>
...
</li><li>Perpustakaan pada perguruan tinggi negeri dan perguruan tinggi swasta;</li>
<li>Lembaga Lain yang bergerak di bidang pengembangan dokumentasi dan informasi hukum yang ditetapkan olen Menteri.</li>
<p class="text_content">Selain itu, amanat pada Peraturan Presiden Nomor 33 Tahun 2012 menegaskan bahwa tujuan dari JDIHN adalah:</p>
<ol type="a">
