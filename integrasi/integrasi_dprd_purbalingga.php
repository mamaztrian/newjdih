...
$servername = "global-db";//diisi nama server
$username = "jdih-dprd";//diisi nama user db
$password = "dprd2021@@#";//diisi password db
$dbname = "jdih-dprd";//diisi nama database
$varjson = array();
...
$row_array->urlDownload='http://jdih-dprd.purbalinggakab.go.id/common/dokumen/'.$row["sc_lampiran"];//berisi url dan nama file ex. domain.com/peraturan.pdf atau menyesuaikan
$row_array->urlDetailPeraturan='http://jdih-dprd.purbalinggakab/dokumen/view?id='.$row["sc_id"]; //berisi url halaman detail peraturan silahkan ganti s..........
